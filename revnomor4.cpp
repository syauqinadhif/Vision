...
int main( int argc, char** argv )
{
    ...
    cv::VideoCapture video("Resources/nomor4.mp4");
    ...
    */
    ...
    {   
        ...
        for(int i=0; i<contours.size(); i++)
        {
            ...
            cv::drawContours(drawing, hull, i, color, -1);
        }
        Mat kernel = getStructuringElement(MORPH_RECT, Size(60,60));
        Mat elemen = getStructuringElement(MORPH_RECT, Size(250,250));

        morphologyEx(drawing, drawing, MORPH_CLOSE, kernel);
        morphologyEx(drawing, drawing, MORPH_OPEN, elemen);
